...
class Parallel_Welcome {
		...
		?>
			<div class="notice theme-notice">
				...
				<div class="theme-notice-cta">
					<a href="<?php echo esc_url( admin_url( 'themes.php?page=parallel-welcome#getting_started' ) ); ?>" class="button button-hero" style="text-decoration: none;"><?php esc_html_e( 'Setup Instructions', 'parallel' ); ?> <?php echo $dismiss_url ?></a>
					<a target="_blank" href="<?php echo esc_url('http://demo.themely.com/parallel/'); ?>" class="button button-hero" style="text-decoration: none;"><?php esc_html_e( 'View Live Demo', 'parallel' ); ?></a>
	...
	public function parallel_welcome_screen() {
		...
		<div class="wrap about-wrap theme-welcome">
            ...
            <h1><?php esc_html_e('Welcome to Parallel', 'parallel'); ?> <span><?php esc_html_e('VERSION 1.4.3.8', 'parallel'); ?></span></h1>
